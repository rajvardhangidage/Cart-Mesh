...
Implemented functional API and UI foundation across authentication, catalog, inventory, cart, order, payment and notification domains. Added PostgreSQL/Flyway persistence, API gateway routes, validation, optimistic inventory locking, payment idempotency, Actuator endpoints, Docker infrastructure, GitHub CI workflows and a responsive React storefront.
